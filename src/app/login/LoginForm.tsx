      ...
      <form action={isLogin ? login : signup} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        <div>
          ...
          <input 
            ...
            style={{ width: '100%', padding: '0.75rem 1rem', borderRadius: '8px', border: '1px solid var(--border-color)', backgroundColor: 'var(--bg-color)', color: 'var(--text-heading)', outline: 'none' }} 
        ...
        <button 
          ...
          style={{ marginTop: '0.5rem', padding: '0.85rem', fontSize: '1rem', fontWeight: 'bold', width: '100%' }}>
